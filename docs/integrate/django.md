...
import {
  ...
  createCorePlugins,
  AlignmentPlugin,
} from '/static/node_modules/on-codemerge/dist/app.mjs';
import '/static/node_modules/on-codemerge/dist/public.css';
import '/static/node_modules/on-codemerge/dist/index.css';
...
class DjangoEditor {
  ...
  async init() {
    ...
    const initialContent =
      ...
      'Welcome to On-Codemerge with Django!';
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{% static 'node_modules/on-codemerge/dist/public.css' %}" />
    <link rel="stylesheet" href="{% static 'node_modules/on-codemerge/dist/index.css' %}" />
  </head>
  <body>
    <div class="container">
    ...
    {% if initial_content %}
    <script id="initial-content" type="text/plain">
