...
export const SHORTCUTS: ShortcutCategories = {
  ...
  'Media': [
    ...
    { keys: 'Ctrl+Shift+Y', description: 'Insert YouTube video', command: 'youtube-video', icon: '▶️' },
  ],
  'Links': [
    { keys: 'Ctrl+K', description: 'Insert link', command: 'link', icon: '🔗' },
  ],
  'Blocks': [
  ...
  'Export': [
    { keys: 'Ctrl+E', description: 'Export document', command: 'export', icon: '📤' },
  ],
  'Miscellaneous': [
